...
class Autocomplete extends React.Component {
  ...
  exposeAPI() {
    IMPERATIVE_API.forEach(event => this[event] = (this.references.input.current && this.references.input.current[event] && this.references.input.current[event].bind(this.references.input.current)))
  }
  ...
  maybeScrollItemIntoView() {
    ...
    if (this.isOpen() && highlightedIndex !== null && this.references[`item-${highlightedIndex}`] !== null ) {
      const itemNode = this.references[`item-${highlightedIndex}`].current;
