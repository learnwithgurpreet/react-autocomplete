...
class Autocomplete extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.autoHighlight && (prevProps.value !== this.props.value || prevState.highlightedIndex === null)) {
  ...
  renderMenu = () => {
    ...
    const menu = renderMenu(items, value, {...menuStyle, ...style}, suggestionsMenuId)
